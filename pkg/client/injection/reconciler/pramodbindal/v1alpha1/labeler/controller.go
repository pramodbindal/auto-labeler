...
import (
	...
	versionedscheme "github.com/pramodbindal/auto-labeler/pkg/client/clientset/versioned/scheme"
	client "github.com/pramodbindal/auto-labeler/pkg/client/injection/client"
	labeler "github.com/pramodbindal/auto-labeler/pkg/client/injection/informers/pramodbindal/v1alpha1/labeler"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "labelers.pramodbindal.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "pramodbindal.dev.Labeler"),
	)
