...
import (
	...
	v1alpha1 "github.com/pramodbindal/auto-labeler/pkg/apis/pramodbindal/v1alpha1"
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pramodbindalv1alpha1.LabelerLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Labeler, desiredFinalizers sets.Set[string]) (*v1alpha1.Labeler, error) {
	...
	patcher := r.Client.PramodbindalV1alpha1().Labelers(resource.Namespace)
